...
public class DateAndTime_01_Test {
    ...
    public void test_date() {
        ...
        assertThat(date.toString(), is("Fri Mar 24 01:02:03 GMT 2017"));

        // une date est mutable... :-(
        // TODO modifier le jour de la date pour que le test soit passant
        date = new Date(117, 2, 25, 1, 2, 3);

        assertThat(date.toString(), is("Sat Mar 25 01:02:03 GMT 2017"));
    }
    ...
    public void test_calendar() throws Exception {
        ...
        assertThat(calendar.getTime().toString(), is("Fri Mar 24 01:02:03 GMT 2017"));

        // calendar est mutable... :-(
        // TODO modifier l'objet calendar pour que le test soit passant
        calendar.set(Calendar.DAY_OF_MONTH, 25);

        assertThat(calendar.getTime().toString(), is("Sat Mar 25 01:02:03 GMT 2017"));
    }

...
public class Optional_01_Test {
    ...
    // tag::findMethod[]
    <T> T find(List<T> list, Predicate<T> predicate, T defaultPerson) {
        T result = defaultPerson;
    ...
    public void test_optional_found() throws Exception {
        ...
        // TODO age == 10
        Optional<Person> result = Optional.ofNullable(find(personList, t -> t.getAge()==10, null));
